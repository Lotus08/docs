...
1. When a user subscribes to a topic in your app, a subscription record is created with the status `subscribed`. You can [unsubscribe](/docs/rest-api/reference#unsubscribe-topic-subscription) and [resubscribe](/docs/rest-api/reference#create-topic-subscription) the user using the REST API.
